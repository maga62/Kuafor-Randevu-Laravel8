                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            ...
                            <div>
                                <div class="feed-activity-list">
                                    ...
                                    <div class="feed-element">
                                        <a class="float-left" href="profile.html">
                                            <img alt="image" class="rounded-circle" src="/assets/admin/img/profile.jpg">
                                        </a>
                                    ...
                                    <div class="feed-element">
                                        <a class="float-left" href="profile.html">
                                            <img alt="image" class="rounded-circle" src="/assets/admin/img/a2.jpg">
                                        </a>
                                        <div class="media-body ">
                                    ...
                                    <div class="feed-element">
                                        <a class="float-left" href="profile.html">
                                            <img alt="image" class="rounded-circle" src="/assets/admin/img/a3.jpg">
                                        </a>
                                        <div class="media-body ">
                                            <small class="float-right">2h ago</small>
                                    ...
                                    <div class="feed-element">
                                        <a class="float-left" href="profile.html">
                                            <img alt="image" class="rounded-circle" src="/assets/admin/img/a4.jpg">
                                        </a>
                                        <div class="media-body ">
                                    ...
                                    <div class="feed-element">
                                        <a class="float-left" href="profile.html">
                                            <img alt="image" class="rounded-circle" src="/assets/admin/img/a5.jpg">
                                        </a>
                                        <div class="media-body ">
                                            <small class="float-right">2h ago</small>
                                    ...
                                    <div class="feed-element">
                                        <a class="float-left" href="profile.html">
                                            <img alt="image" class="rounded-circle" src="/assets/admin/img/a7.jpg">
                                        </a>
                                        <div class="media-body ">
                                ...
                                <button class="btn btn-primary btn-block m-t"><i class="fa fa-arrow-down"></i> Show More
                                </button>
