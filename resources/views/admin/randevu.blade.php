...
@section("title","Kuaför Admin randevu")
@section("content")
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="/admin/randevu">Randevu</a>
                </li>
                <li class="breadcrumb-item active">
                    <strong>Randevu List</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
